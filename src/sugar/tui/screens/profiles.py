# src/sugar/tui/screens/profiles.py
from textual.app import ComposeResult
from textual.screen import Screen
from textual.widgets import Static, DataTable, Button, Header, Footer, Rule, Label
...
class ProfileScreen(Screen):
    ...
    def _create_profiles_table(self) -> DataTable:
        """Create the profiles table."""
        # Create the table and give it explicit height styling
        profiles_table = DataTable(id="profiles-detail-table")
        ...
        profiles_table.add_rows([
            ("development", "project-dev", "containers/dev/compose.yaml", "frontend, api, db", "● Active"),
            ("staging", "project-staging", "containers/staging/compose.yaml", "All services", "● Active"),
            ("production", "project-prod", "containers/prod/compose.yaml", "web, api, db, cache", "○ Inactive"),
            ("testing", "project-test", "containers/test/compose.yaml", "test-suite, mockdb", "○ Inactive")
        ])
    ...
    def on_mount(self) -> None:
        ...
        self._update_profile_details("development", "project-dev", "containers/dev/compose.yaml", "frontend, api, db")
    
    def _update_profile_details(self, name, project, config, services):
        ...
        if not self.query("#profile-details"):
            details = Vertical(
                ...
                Horizontal(
                    ...
                    Label(services, classes="detail-value", id="services-list")
                ),
                id="profile-details"
            )
    ...
    def on_data_table_row_selected(self, event):
        ...
        if row_idx is not None:
            ...
            self._update_profile_details(row_data[0], row_data[1], row_data[2], row_data[3])
