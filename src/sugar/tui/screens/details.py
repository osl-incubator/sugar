# src/sugar/tui/screens/details.py
from textual.app import ComposeResult
from textual.screen import Screen
from textual.widgets import Static, Button, Rule, Label, Header, Footer, DataTable
...
class DetailsScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Container(
            Vertical(
                ...
                Horizontal(
                    Static("Container and configuration information", classes="subtitle"),
    ...
    def _create_config_panel(self) -> Vertical:
        ...
        return Vertical(
            ...
            Horizontal(
                ...
                Label("abc123def456", classes="detail-value", id="container-id")
            ),
            Horizontal(
                Label("Created:", classes="detail-label"),
                Label("2024-03-07 08:42:15", classes="detail-value", id="created-at")
            ),
            Horizontal(
            ...
            Horizontal(
                ...
                Label("NGINX_HOST=example.com, PORT=80", classes="detail-value", id="env-vars")
            ),
            id="config-details"
        )
    ...
    def _create_stats_panel(self) -> Vertical:
        ...
        return Vertical(
            ...
            Horizontal(
                ...
                Label("128MB / 512MB", classes="detail-value", id="memory-usage")
            ),
            Horizontal(
    ...
    def _create_volumes_panel(self) -> DataTable:
        """Create the volumes panel."""
        volumes_table = DataTable(id="volumes-table")
    ...
    def _create_network_panel(self) -> DataTable:
        """Create the network panel."""
        network_table = DataTable(id="network-table")
